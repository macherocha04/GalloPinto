                        ...
                        <div class="product-img">
                            ...
                            <div class="button-head">
                                <div class="product-action">
                                    ...
                                    <a title="Lista de Deseos" href="{{route('add-to-wishlist',$product->slug)}}" class="wishlist" data-id="{{$product->id}}"><i class="ti-heart"></i><span>Añadir a la Lista de Deseos</span></a>
                                </div>
                            ...
                            <div class="modal-body">
                                <div class="row no-gutters">
                                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <!-- Fin de la galería de productos -->
                                    </div>
                                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
...
<!-- Compartir --><div class="sharethis-inline-share-buttons"></div><!-- Fin de Compartir -->
</div>
